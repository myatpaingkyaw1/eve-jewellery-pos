  ...
  return (
    <div className="footer-container">
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-sm-6 mb-5 mb-lo-0 text-center text-sm-left mr-auto">
                        <div class="footer-widget">
                            <h4 class="mb-4">EVE JEWELLERY</h4>
                            <p class="lead">Iste dolores iure quis excepturi, deserunt praesentium.</p>
                            <div class="">
                                <p class="mb-0"><strong>Location:</strong>GabarAye Gamone Pwint, YANGON</p>
                                <p><stron>Support Email : </stron>evejewellery@gmail.com</p>
                            </div>
                        </div>
                    </div>
